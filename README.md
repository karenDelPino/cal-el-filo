...
src/assets: Imágenes, logos de clientes y recursos gráficos.

src/componentes: Elementos reutilizables

src/paginas: Vistas principales del sitio.

src/estilos: Archivos CSS personalizados por sección.
